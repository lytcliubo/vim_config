...
function RetabIndents()
    let auto_striptab = exists('g:auto_striptab') ? g:auto_striptab : "python,c,cpp,h,hpp"
...
function StripTrailingWhite()
    let auto_striptrail = exists('g:auto_striptrail') ? g:auto_striptrail : "python,c,cpp,h,hpp"
